...
public class SpecialVehicle extends Vehicle{
    public SpecialVehicle(String id, VehicleRole role, int initialSpeed, RoadPoint initialPosition, String clientEndpoint, String certificateFile, String privateKeyFile) {
