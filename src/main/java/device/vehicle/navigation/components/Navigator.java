...
import main.java.device.vehicle.navigation.interfaces.*;
import main.java.device.vehicle.navigation.types.*;
import main.java.device.vehicle.navigation.utils.MySimpleLogger;
import main.java.device.vehicle.navigation.utils.MyBean;
...
//	   this.setOffRoadMode(false);
   ...
   protected INavigator _move(int distance, IRoadPoint posicionActual) {
	  ...
	  boolean movemos_direccion_ascendente_PKs = (rf.getEndPoint().getPosition() >= posicionActual.getPosition());
